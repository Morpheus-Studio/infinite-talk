...
def run(job_id: str, video_path: str, audio_path: str, s3_output_path: str, prompt: str, resolution: str, quantized: bool, scene_seg: bool, lora_path: Optional[str] = None):
    """
